...
const AthleteDashboard: React.FC = () => {
    ...
    const acwrHighRisk = acwrValue > 1.5 || acwrValue < 0.8; // Local calc for UI logic
    ...
    const DashboardView = () => (
        <div className="space-y-12 animate-fade-in-up">
            ...
            {/* 1. Quick Glance Scorecards (Elite Portal New Feature) */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Performance Score */}
                <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 relative overflow-hidden group hover:border-white/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        <div className="p-3 bg-blue-900/20 rounded-xl">
                            <TrendingUp className="w-6 h-6 text-blue-500" />
                        </div>
                        <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">VALD Force</span>
                    </div>
                    <div className="relative z-10">
                        <h3 className="text-4xl font-black text-white mb-1">
                            {analysis.scores?.performance ?? 0}<span className="text-lg text-gray-500 font-normal">%</span>
                        </h3>
                        <p className="text-sm text-gray-400">Force Output Score</p>
                    </div>
                ...
                <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 relative overflow-hidden group hover:border-white/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">Mobility</span>
                    </div>
                    <div className="relative z-10">
                        <h3 className="text-4xl font-black text-white mb-1">
                            {analysis.scores?.screening ?? 0}<span className="text-lg text-gray-500 font-normal">/100</span>
                        </h3>
                ...
                <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 relative overflow-hidden group hover:border-white/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">Daily Log</span>
                    </div>
                    <div className="relative z-10">
                        <h3 className="text-4xl font-black text-white mb-1">
                            {analysis.scores?.readiness ?? 0}<span className="text-lg text-gray-500 font-normal">%</span>
                        </h3>
                        <p className="text-sm text-gray-400">Recovery Status</p>
                    </div>
                    <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-green-500/10 rounded-full blur-2xl group-hover:bg-green-500/20 transition-all"></div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-gray-400 text-xs mt-4">
                                Target: 0.8 - 1.3 <br />
                                <span className={acwrHighRisk ? 'text-red-500 font-bold' : 'text-green-500 font-bold'}>
                                    {acwrHighRisk ? 'HIGH RISK' : 'OPTIMAL'}
                                </span>
                            </p>
                        </div>
    ...
    const GoalsView = () => (
        <div className="animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2 bg-neutral-900 border border-neutral-800 rounded-2xl p-8 mt-4">
                    <h3 className="text-xl font-bold text-white mb-4">Commitment Contract</h3>
                    <p className="text-gray-400 mb-4 text-sm">I hereby commit to the standards set above.</p>
                    <div className="bg-black border-2 border-dashed border-gray-700 rounded-xl p-4 h-32 flex items-center justify-center text-gray-500 italic">
    ...
    return (
      ...
      `}>
                ...
                <nav className="p-4 space-y-2">
                    ...
                    <button
                        onClick={() => { setActiveView('goals'); setSidebarOpen(false); }}
