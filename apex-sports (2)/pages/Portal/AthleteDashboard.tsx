...
const AthleteDashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col md:flex-row relative overflow-x-hidden" ref={dashboardRef}>
            ...
            <div className={`
                fixed inset-y-0 left-0 z-50 w-72 bg-neutral-900 border-r border-gray-800 transform transition-transform duration-300 ease-in-out no-print
                md:translate-x-0 md:fixed md:top-24 md:bottom-0 md:h-[calc(100vh-6rem)] md:z-40
            ...
            {/* Main Content Area */}
            {/* Added md:ml-72 to account for fixed sidebar, and md:pt-28 to account for global navbar */}
            <div className="flex-1 overflow-y-auto min-h-screen bg-black w-full md:ml-72 md:pt-28">
