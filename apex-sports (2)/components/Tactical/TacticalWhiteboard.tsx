    ...
    return (
        <div className="flex flex-col gap-6 h-full">
            <div className={`flex flex-col h-full rounded-3xl overflow-hidden border flex-1 shadow-2xl relative transition-colors ${isPRG ? 'bg-[#0a0a2a] border-[#ceb888]/30' : 'bg-neutral-900 border-blue-500/30'}`}>
                ...
                <div
                    ref={containerRef}
                    className={`relative overflow-hidden cursor-crosshair select-none w-full shadow-2xl transition-all duration-300 ${view === 'full' ? 'bg-[#0a0a2a] aspect-[9/16] w-full' : (isPRG ? 'bg-[#2c62c6]' : 'bg-blue-600') + ' max-w-[800px] mx-auto aspect-[3/4] h-auto'
                        }`}
                ...
                >
                    ...
                    <img
                        ...
                        className={`absolute inset-0 w-full h-full pointer-events-none opacity-100 transition-all duration-500 ${view === 'full' ? 'rotate-90' : view === 'half' ? 'scale-90' : ''}`}
                        style={getImageStyle()}
                        alt="Pitch"
                    />
